...
const Hero = () => {
  ...
  return (
    <motion.section 
      className="min-h-screen bg-gradient-to-br from-blue-100 to-green-100 flex items-center justify-center px-4 sm:px-6 lg:px-8"
      initial="hidden"
      animate="visible"
      ...
      <div className="max-w-7xl w-full space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <motion.div className="space-y-8" variants={itemVariants}>
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-500 leading-tight">
              RON CABATUANDO
            </h1>
            ...
            <div className="flex space-x-6">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link to="/contact" className="px-8 py-4 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition duration-300 ease-in-out flex items-center space-x-2 shadow-lg">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <a href="/path-to-your-cv.pdf" download className="px-8 py-4 bg-green-600 text-white font-semibold rounded-full hover:bg-green-700 transition duration-300 ease-in-out flex items-center space-x-2 shadow-lg">
            ...
            <div className="flex items-center space-x-6 pt-8">
              <span className="text-gray-700 font-semibold">FOLLOW ME ON</span>
              <motion.a whileHover={{ scale: 1.2 }} href="https://linkedin.com/in/your-profile" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700">
              ...
              <motion.a whileHover={{ scale: 1.2 }} href="https://github.com/your-username" target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:text-gray-900">
              ...
              <motion.a whileHover={{ scale: 1.2 }} href="https://twitter.com/your-handle" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-500">
